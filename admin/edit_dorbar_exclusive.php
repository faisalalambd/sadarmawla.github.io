...
include 'config.php';
$id=$_GET['id'];
$sql = "SELECT * FROM suac_bio where id=$id";
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <!-- ############################## Form ############################## -->
                    <form action="update_dorbar_exclusive.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <!--    <div class="col-sm-9">-->
                            <!--        <input type="text" class="form-control" placeholder="Author Name" value="<?php echo $author?>" name="author" required>-->
                            <!--    </div>-->
                            <!--</div>-->
