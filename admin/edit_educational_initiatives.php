...
include 'config.php';
$id=$_GET['id'];
$sql = "SELECT * FROM educational_initiative where id=$id";
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <!-- ############################## Form ############################## -->
                    <form action="update_educational_initiative.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
