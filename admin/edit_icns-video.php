...
include 'config.php';
$id=$_GET['id'];
$sql = "SELECT * FROM icns_video where id=$id";
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <!-- ############################## Form ############################## -->
                    <form action="update_icns-video.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Youtube Video Link</strong></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="YOutube Video" value="<?php echo $link?>" name="link" required>
                                </div>
                            </div>
