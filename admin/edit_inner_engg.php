            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Update: Inner engg.</h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="update_inner_engg.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="summernote" name="shortdescription" value="<?php echo $shortdescription?>"><?php echo $shortdescription?></textarea>
                                </div>
                            </div>
