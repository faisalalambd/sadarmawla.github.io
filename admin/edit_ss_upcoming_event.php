...
include 'header.php';
echo $id=$_GET['id'];
$sql = "SELECT * FROM 	ss_upcomming_event where id=$id";
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Form:Upcomming Events</h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="update_ss_upcoming_event.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
