...
$sql = "SELECT * FROM icns_different_shrines  order by id desc";
...
?>
                                    <tr>
                                        ...
                                        <td style="display: inline-flex;">
                                            <a href="edit_icns_different_shrines.php?id=<?php echo $row['id']?>" class="btn btn-icon btn-primary">Edit</a>
                                            <form action="delete_icns_different_shrines.php?id=<?php echo $row['id']?>" method="post">
