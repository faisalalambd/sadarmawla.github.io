                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="text-right">
                                <a href="create_wisdom.php" class="btn btn-icon icon-left btn-primary"><i class="fa-solid fa-plus"></i> Add New</a>
                            </div>
                                    ...
                                    <tr>
                                      ...
                                      <td><?php echo $row['image_title']?></td>
                                        ...
                                        <td style="display: inline-flex;">
                                            <a href="edit_wisdom.php?id=<?php echo $row['id']?>" class="btn btn-icon btn-primary">Edit</a>
                                            <form action="delete_wisdom.php?id=<?php echo $row['id']?>" method="post">
